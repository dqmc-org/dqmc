...
// -----------------------  Utils::SvdStack class for multiplications of matrix
// stacks  ---------------------- udv stack of a matrix product: u * d * vt =
// ... A_2 * A_1 * A_0
class SvdStack {
 private:
 ...
 public:
  ...
  // clear the stack
  // simply set stack_length = 0, note that the memory is not really
  // deallocated.
  void clear();
