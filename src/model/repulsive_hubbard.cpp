...
RealScalar RepulsiveHubbard::ChemicalPotential() const {
...
void RepulsiveHubbard::initial_params(const LatticeBase& lattice,
                                      const Walker& walker) {
...
void RepulsiveHubbard::initial_KV_matrices(const LatticeBase& lattice,
                                           const Walker& walker) {
...
void RepulsiveHubbard::initial(const LatticeBase& lattice,
                               const Walker& walker) {
...
void RepulsiveHubbard::update_greens_function(Walker& walker,
...
void RepulsiveHubbard::mult_B_from_left(GreensFunc& green, TimeIndex time_index,
                                        Spin spin) const {
...
void RepulsiveHubbard::mult_B_from_right(GreensFunc& green,
                                         TimeIndex time_index,
                                         Spin spin) const {
...
void RepulsiveHubbard::mult_transB_from_left(GreensFunc& green,
                                             TimeIndex time_index,
                                             Spin spin) const {
  // Multiply a dense matrix, specifically a greens function, from the left by
  // B(t)^T
